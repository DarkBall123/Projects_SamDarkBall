## Arma 3: Tree View Path

- Source: https://community.bistudio.com/wiki/Arma_3:_Tree_View_Path
- Revision: 338770
- Updated: 2023-04-05T16:50:45Z

thumb|600px|Tree View arrays in action
...
The command will then return index of added item relative to the parent item. If parent item doesn't exist (happens when item is added to the main trunk of the tree), the parent path needs to be an empty array
