...
1. A config addon that extends the module’s list of known assets
...
1. Place every house you wish to furnish, space them at least one house’s width apart from each other. More space is better.
1. Place furniture inside every house
1. Save the mission
1. Create a new init.sqf file in that mission
1. Paste the following contents into that init.sqf:
...
1. Your Clipboard (Ctrl + V) now contains the Furniture Offset List
1. Create a new file and call it “yourmod_furniture.sqf”, paste the contents of your clipboard into there
1. Create a new config addon (We’ll assume you have the basic addon skills to do so)
1. Add this class to your config, and customize the names and paths to match your addon and generated list.
...
1. Pack the addon.
1. The Automatic Furniture Module will now be able to deal with your assets.
