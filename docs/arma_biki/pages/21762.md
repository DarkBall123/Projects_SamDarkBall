...
The variable "_this" was available until 2.18 and contained an empty string. From 2.18, it is not available anymore.
...
|type2=String
|value2="pixelW"
|description=The button's text & background will move by this distance horizontally when pressed. Distance is in UI Coordinates.
...
|type2=String
|value2="pixelH"
|description=The button's text & background will move by this distance vertically when pressed. Distance is in UI Coordinates.
(If a shadow is defined, it will stay in place.)
}}
...
See Description.ext#CfgCommands to allow URLs.
}}
