...
- Source: https://community.bistudio.com/wiki/Compressed_LZSS_File_Format
- Revision: 373436
...
The patent for LZSS can be found [Here](http://www.patentstorm.us/patents/5701125/description.html)

Generalised Code (from which bis lzss is based) can be found [here](http://dev.gameres.com/Program/Other/LZSS.C)
...
For more on specific methods of implementation visit [here](http://michael.dipperstein.com/lzss)
