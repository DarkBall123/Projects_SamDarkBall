...
- Revision: 378915
- Updated: 2026-08-12T19:46:48Z

- Availability: arma2 1.00, arma2oa 1.50, tkoh 1.00, arma3 0.50
- Groups: Teams, Object Detection
...
```sqf
agents apply {typeOf agent _x}; // ["Snake_random_F","Snake_random_F","Snake_random_F","Rabbit_F"]
```
...
|text= Note that agents returns a reference to the agent itself, not the object. For example: 
...
```
 ...
 But you can assign the agent a reference using setVariable, and then reference it, for example: 
