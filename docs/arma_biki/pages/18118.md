...
* only as of 1.68 do simple objects support getVariable and setVariable.
...
- positionWorld: PositionASL - placement position by the **model centre**<nowiki/>'s position (see getPosWorld)
