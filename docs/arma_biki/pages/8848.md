...
### Check if Enabled (1.56)

```sqf
ppEffectEnabled handle;
```
...
[More info on the forums](https://forums.bohemia.net/forums/topic/220199-hbaoplus-post-processing-effect/).
