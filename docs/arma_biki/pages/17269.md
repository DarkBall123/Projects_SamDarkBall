...
1. Mission config (defined in the description.ext) overwrites Editor/mission settings
1. Editor/mission settings are considered last and do not overwrite anything
