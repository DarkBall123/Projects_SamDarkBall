## Arma 2: Ambient Civilian Vehicles

- Source: https://community.bistudio.com/wiki/Arma_2:_Ambient_Civilian_Vehicles
- Revision: 347052
- Updated: 2023-08-28T22:35:07Z
...
```sqf
BIS_silvie_mainScope setVariable ["vehicleCount", "round (%1 / 10)"];
```
...
```sqf
BIS_silvie_mainScope setVariable ["roadDistance", 30];
```
...
```sqf
BIS_silvie_mainScope setVariable ["attempts", 20];
```
...
These variables are only to be read and must not be modified!
