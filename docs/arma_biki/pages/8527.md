## Arma 2: Garbage Collector

- Source: https://community.bistudio.com/wiki/Arma_2:_Garbage_Collector
- Revision: 347047
- Updated: 2023-08-28T21:59:53Z
...
```sqf
0 = [unit] execVM "ca\modules\garbage_collector\data\scripts\trashIt.sqf";
```

. You can refer to the Garbage Collector using `BIS_GC`.
