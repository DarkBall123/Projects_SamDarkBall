...
The requiredAddons array in CfgPatches is how you control the load order of configs. "requiredAddons" means "load these other config files before you load this one." (And "this one" means the name of the class containing the requiredAddons statement). [text= A](link= http://forums.bistudio.com/showthread.php?162880-Little-question-about-cfgpatches)
...
1. CfgSkeleton & CfgModels classes should be in either: a "model.cfg" file or a "[same-name-as-P3D].cfg" file. Unlike other config classes, these ones should not be thrown into random files.
1. The model.cfg file must be in the same folder as--or in a parent folder of--the object (P3D) it configures.
...
`c= airFriction = deceleration / velocity2`
...
A, [text= B](link= http://forums.bistudio.com/showthread.php?153417-airFriction), "WW2 Ballistics: Armor and Gunnery" (Bird-Livingston, 2001)

For self-propelled rockets and missiles use this one:

`c=  -0.002 * f = a / v2` (finding in [text= BI forum](link= https://forums.bistudio.com/forums/topic/189449-solved-simulate-rocket-flight-airfriction-correction-thrust-in-cfgammo-is-equal-to-acceleration/?do=findComment&comment=3002852))
...
[text= A](link= https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_airLock.htm?Highlight=airlock), B, [text= C](link= http://forums.bistudio.com/showthread.php?47996-Airlock-only).
...
`c= caliber = (mm penetration @speedX)*1000 / (bulletPenetrability * speedX)`
...
[A](http://resources.bisimulations.com/wiki/Damage_Modeling:_Simulation#Penetration)
...
A, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_cost.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____12) (contradictory)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_deflecting.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____15)
...
A, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_laserLock.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____40).
...
A, {{Link|https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_manualControl.htm?Highlight{{=}}manualcontrol|B}}
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_maneuvrability.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____45), B
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_maxControlRange.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____47), B
...
The default appears to be between 0.05 (visible in "Splendid Config Viewer" though it is not clear where this is defined?). If you assign a *lower* value, the game tracks the projectile *more often*, giving a finer grained precision to its trajectory. This is presumably useful for things like fast moving projectiles, fast maneuvering guided missiles, projectiles with a high airFriction value, etc. A *higher* value tracks the projectile with *less detail*. The results can be a bit unpredictable (e.g. values less than 0.001 can cause bizarre trajectories), so experimentation with a [text= projectile tracing script](link= http://forums.bistudio.com/showthread.php?164294-Quick-and-fun-projectile-path-tracing!) is useful if you feel like there may be something wrong with your projectile's trajectory.
...
[A](https://manuals.bisimulations.com/vbs3/3-6/devref/Content/Config_Manual/CfgAmmo/amm_simulationStep.htm)
...
A, B, {{Link|https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_thrustTime.htm?Highlight{{=}}thrusttime|C}}
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_timeToLive.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____76)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_visibleFire.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____85)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgAmmo/amm_visibleFireTime.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CcfgAmmo%7C_____86), B
...
[A](https://manuals.bisimulations.com/vbs2/2-00/devref/Content/Config_Manual/CfgWeapons/wpn_autoFire.htm)
...
A, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgWeapons/wpn_canLock.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgWeapons%7C_____18)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgWeapons/wpn_maxRange.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgWeapons%7C_____67)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/A_cpp/cpp_animSourceBody.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____31), B
...
{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}Damage_Modeling:_Objects#armor|A}}, B, C.
...
A, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/B_cpp/cpp_brakeIdleSpeed.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____53)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/C_cpp/cpp_cost.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____92)
...
A, [B](https://developer.nvidia.com/sites/default/files/akamai/physx/Docs/Vehicles.html#pxvehicleautoboxdata)
...
A, [B](https://developer.nvidia.com/sites/default/files/akamai/physx/Docs/Vehicles.html#pxvehicleclutchdata)
...
[ [|text= A](link= http://forums.bistudio.com/showthread.php?149636-Development-Branch-Changelog&p=2818157&viewfull=1#post2818157) ]
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/C_cpp/cpp_crewVulnerable.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____95)
...
{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}Damage_Modeling:_Objects#destrType|A}}, [B](https://manuals.bisimulations.com/vbs3/3-4/devref/#Config_Manual/CfgVehicles/D_cpp/cpp_destrType.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____110)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/E_cpp/cpp_engineLosses.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____139)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/F_cpp/cpp_forceHideCommander.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____153)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/E_cpp/cpp_extCameraPosition.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____141)

#### __Fov
`c= **float≥0**, 1=120 degrees`
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/I_cpp/cpp_initFov.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____234)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/F_cpp/cpp_fuelCapacity.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____162)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/G_cpp/cpp_gunnerOpticsModel.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____197)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/G_cpp/cpp_gunnerOutOpticsModel.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____202)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/G_cpp/cpp_gunnerHasFlares.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____192), (comment in "Samples_F\Test_Tank_01\CfgVehicles.hpp")
...
[ [text= A](link= https://manuals.bisimulations.com/vbs3/3-0/devref/Content/Config_Manual/CfgVehicles/H_cpp/cpp_hiddenSelections.htm), [text= B](link= http://forums.bistudio.com/showthread.php?93033-Hidden-Selections), [text= C](link= http://fab.ofp.free.fr/Tutorials/Hidden_Selections.htm), [text= D](link= http://tactical.nekromantix.com/wiki/doku.php?id=arma2:texturing:hiddenselectionstextures) E]
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/I_cpp/cpp_inGunnerMayFire.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____230)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/M_cpp/cpp_magazines.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____277)
...
A, [B](https://developer.nvidia.com/sites/default/files/akamai/physx/Docs/Vehicles.html#pxvehicleenginedata)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/Content/Config_Manual/CfgVehicles/O_cpp/cpp_outGunnerMayFire.htm)

#### peakTorque
`**int>0**, Newton-meters, (PhysX)`

Maximum engine torque. (`c= =enginePower*1000/maxOmega`).
...
{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}Damage_Modeling:_Objects#secondaryExplosion|A}}, [B](http://resources.bisimulations.com/wiki/Damage_Modeling:_Objects#armor), [C](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/S_cpp/cpp_secondaryExplosion.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____424)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/S_cpp/cpp_simulation.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____447)
...
[(comment in "Samples_F\Test_Tank_01\CfgVehicles.hpp"), [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/S_cpp/cpp_smokeDischarger_grenadesPerUse.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____449)]
...
[,[B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/S_cpp/cpp_smokeDischarger_onturret.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____450)]
...
See FilmGrain Post Processing effect.
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/T_cpp/cpp_Threat.htm%3FTocPath%3D4%20Configuration%20Manual%7CCfgVehicles%7C_____455)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/T_cpp/cpp_transmissionLosses.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____490)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/T_cpp/cpp_transportSoldier.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____499)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Adding_Models/How_to/AMHT_Turrets_Parameters.htm%3FTocPath%3D2%2520How%2520to...%7CTurrets%7C_____2)
...
[A](http://www.arma3.fr/actu-4366-spotrep_)
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/W_cpp/cpp_weapons.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____550)
...
Here is a list of some key variable names, although there are possibly many more which are undocumented.

{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}Damage_Modeling:_Objects#DestructionEffects_class|A}}, B, [C](https://manuals.bisimulations.com/vbs3/3-4/devref/#Config_Manual/CfgVehicles/P_cpp/cpp_Particle_Effects.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____374)
...
`c= location health = ("armor" local) * ("armor" global)`
...
Darkens material based on damage state. Deprecated--all Arma 3 configs disable it by setting it to -1. If you want to read about how it works, follow this link: [link](http://fab.ofp.free.fr/Tutorials/Damaged_Tank.htm).
...
[A](https://manuals.bisimulations.com/vbs2/2-00/devref/Content/Adding_Models/How_to/AMHT_Physx.htm), [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/D_cpp/cpp_damping.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____104)
...
[A](https://developer.nvidia.com/sites/default/files/akamai/physx/Docs/Vehicles.html#pxvehiclewheeldata), B
...
A, [B](https://developer.nvidia.com/sites/default/files/akamai/physx/Docs/Vehicles.html#pxvehicletiredata)
...
A, [text= B](link= http://forums.bistudio.com/showthread.php?149027-Primer-for-new-vehicle-simulation&p=2493741&viewfull=1#post2493741), [C](https://developer.nvidia.com/sites/default/files/akamai/physx/Docs/Vehicles.html#pxvehicletiredata)
...
A, [B](https://developer.nvidia.com/sites/default/files/akamai/physx/Docs/Vehicles.html#pxvehiclesuspensiondata)
...
`c= damping ratio = springdamperRate / [2*SQRT(springStrength * sprungMass) ]`
...
`c= natural frequency = SQRT(springStrength / sprungMass)`
...
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Config_Manual/CfgVehicles/S_cpp/cpp_steering.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____475)
...
[ A, B, [C](https://manuals.bisimulations.com/vbs3/3-0/devref/Content/Adding_Models/AM_Model_cfg.htm), [D](https://manuals.bisimulations.com/vbs3/3-0/devref/Content/Config_Manual/Model_cfg/Model_cfg.htm) ]

#### CfgSkeletons

#### CfgModels
##### class Animations
{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}Model_Config#Animation_Properties|A}}, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Adding_Content/Animations/AM_Animation_Parameters.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CAnimations%7C_____3)
###### type
`**string**`

The type of animation that will occur. Choose from one of the preset animation types (rotation, translation, hide, etc.)

{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}Model_Config#Animation_types|A}}, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Adding_Content/Animations/AM_Animation_Types.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CAnimations%7C_____1)
...
{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}Model_Config#Animation_sources|A}}, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/Content/Adding_Content/Animations/AM_Custom_Controllers.htm)
...
[A](https://manuals.bisimulations.com/vbs3/3-6/devref/Content/Adding_Content/AM_Model_cfg.htm)
...
{{Link|https://resources.bisimulations.com/w/index.php?title{{=}}How_to_animate_a_model#Example_4|A}}, [B](https://manuals.bisimulations.com/vbs3/3-0/devref/#Adding_Content/Animations/AM_Animation_Parameters.htm)

###### hideValue
[A](https://manuals.bisimulations.com/vbs3/3-0/devref/#Adding_Content/Animations/AM_Animation_Parameters.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CAnimations%7C_____3)
...
[text= A](link= http://forums.bistudio.com/showthread.php?149636-Development-Branch-Changelog&p=2812544&viewfull=1#post2812544)
...
A, B, [C](https://manuals.bisimulations.com/vbs3/3-4/devref/#Config_Manual/CfgVehicles/P_cpp/cpp_Particle_Effects.htm%3FTocPath%3D4%2520Configuration%2520Manual%7CCfgVehicles%7C_____374)
