...
Since Arma 3 v1.94: X, Y and Z are limited to values between -50km and +500km. Using any **setPos*** command with values greater than that will [clamp](https://en.wikipedia.org/wiki/Clamping_(graphics)) the value to within these boundaries, not throwing any errors. e.g:
...
center|frame|Obtaining Z for a unit standing on a rock
