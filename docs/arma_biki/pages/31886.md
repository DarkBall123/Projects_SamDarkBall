...
| File
| See [Addon Signature](ArmA: Armed Assault: Addon Signatures) for a file with given index on given user computer, level determines test depth (0 = default, 1 = deep. Note: deep can be very slow)
|-
...
### Mission Scripts Interaction (2.18)
