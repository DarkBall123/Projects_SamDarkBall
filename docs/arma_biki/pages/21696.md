...
1. Place the object
1. Open object attributes
1. Go into Object: Special States
1. Select Simple Object option
...
```sqf
createSimpleObject [objClassName, positionASL];
```
...
```sqf
allSimpleObjects [className1, className2 /*, etc */];
```
