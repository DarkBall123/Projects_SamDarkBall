...
- Revision: 364315
- Updated: 2024-05-06T09:38:45Z

{{TOC|side}}
UI window elements that encompass various display modules and gadgets (Navigation, Camera feeds, Radar...)

Forum topic: [Main thread](https://forums.bistudio.com/topic/200468-jets-custom-info/)
...
For simplicity the class can inherit from one of the [defaults](#Automatic_usage_.26_backwards_compatibility).
...
- Arma 3: Sensors
- Arma 3: Targeting
- [Custom Info thread](https://forums.bistudio.com/topic/200468-jets-custom-info/)
