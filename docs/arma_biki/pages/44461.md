...
- Revision: 376090
- Updated: 2025-08-09T20:40:49Z

{{TOC|side}}

400px|right|Satellite Image|thumb

[Mortain](https://en.wikipedia.org/wiki/Mortain) is an {{GameCategory|arma3|link= y}} terrain, released on the 6th August 2024 as a part of the Spearhead 1944 CDLC.

This new unique terrain is a detailed representation of the actual terrain in Mortain at 1:1 scale where [Operation Lüttich](https://en.wikipedia.org/wiki/Operation_L%C3%BCttich) took place.
...
**In comparison to the Normandy terrain, this terrain brings longer sightlines, bigger fields, sparser hedgerows, and greater changes in elevation. You’ll be fighting on a battlefield perfect for intense combined-arms warfare.**
