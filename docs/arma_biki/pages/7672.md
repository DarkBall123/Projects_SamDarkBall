...
Specific keys cannot be detected with DIK codes, since the position of the keys changes with the Keyboard layout ([QWERTY](https://en.wikipedia.org/wiki/QWERTY), [Dvorak](https://en.wikipedia.org/wiki/Dvorak_Simplified_Keyboard)).
