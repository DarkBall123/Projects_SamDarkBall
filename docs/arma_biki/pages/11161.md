...
thumb|Mission folder with the most common files
#### Folder Name
...
thumb|Example of mission.sqm
#### Mission.sqm

*Main article: Mission.sqm*

{{Clear}}
thumb|Example of Description.ext
#### Description.ext

*Main article: Description.ext*

{{Clear}}
thumb|Example of an *.sqf file
#### Scripts
...
{{Clear}}
thumb|Example of an *.fsm file
#### FSM

*Main article: FSM*

{{Clear}}
thumb|Example of overview.html
#### Overview.html
...
Since {{GameCategory|arma2|link= y}}, briefing.html is only used for the debriefing text. For more information see Arma 2 Briefing creation.
