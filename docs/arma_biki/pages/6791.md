...
Locations:
- are defined in `bin\Config.bin\CfgLocationTypes` /
...
right|thumb|{{arma1}} Location icons and fonts
#### {{arma1}}
...
{{Clear}}
right|thumb|{{arma2}} Location icons and fonts
#### {{arma2}}
...
{{Clear}}
right|thumb|Arma 3 Location icons and fonts
#### Arma 3
