...
- Revision: 353555
- Updated: 2024-03-19T12:01:39Z

{{TOC|side}}
thumb|left|Trigger with ellipse shape
...
File:ArmA_editor_trigger.jpg|{{arma1}}
...
Within the *On Activation* block, *this* is always false, *thisList* refers to the same array as it does in the *Condition* block above, and *thisTrigger* refers to the trigger itself like above. Any expressions in the On Act field must return nothing, or an error message will prevent the trigger dialogue from closing.
...
Any expressions in the On Dea field must return nothing, or an error message will prevent the trigger dialogue from closing.
...
File:ArmA_editor_trigger_effects.jpg|{{arma1}}
