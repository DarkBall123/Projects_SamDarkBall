...
allowedVoteCmds[] =
{
	...
	{ "restart",	true,	true, -1 },			// invalid threshold value. Will default to global `voteThreshold`
...
{{Feature|important|
- Not listing any command (

```
allowedVotedAdminCmds[] = {};
```

) means such commands are disabled for voted-in admin.
