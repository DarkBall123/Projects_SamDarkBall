...
|descr= Returns the combat mode of the given AI group. See setCombatMode for more information about combat modes.

|s1= combatMode group

|p1= group: One of
- Group
- Object of type Unit - if the argument is unit Object, unit's current group is used.
