...
- Source: https://community.bistudio.com/wiki/Arma_3:_createVehicle%2Fvehicles
- Revision: 330465
- Updated: 2022-09-17T23:45:38Z

{{TOC|abc}}
<noinclude>Ancillary sub-page of createVehicle, listing vehicle classes available in Arma 3 including AnimationSources.
arma3contact objects are listed as well.</noinclude>
{{Columns|3|
#### A
...
1. fold_source => user
1. Body_Rotate_source => user
1. damage_petal1 => hit [HitPetal1]
1. damage_petal2 => hit [HitPetal2]
1. damage_petal3 => hit [HitPetal3]
...
1. AnimController_2 => user
1. AnimController_3 => user
1. AnimController_4 => user
...
1. muzzle_rot_HMG => ammorandom
1. cannon_120mm_revolving => revolving
1. HitEngine_src => hit [HitEngine]
1. HitFuel_src => hit [HitFuel]
1. HitHull_src => hit [HitHull]
1. HitMainGun_src => hit [HitGun]
1. HitTurret_src => hit [HitTurret]
1. HitComTurret_src => hit [HitComTurret]
1. HitSLAT_Left_1_src => hit [HitSLAT_Left_1]
1. HitSLAT_Left_2_src => hit [HitSLAT_Left_2]
1. HitSLAT_Left_3_src => hit [HitSLAT_Left_3]
1. HitSLAT_Right_1_src => hit [HitSLAT_Right_1]
1. HitSLAT_Right_2_src => hit [HitSLAT_Right_2]
1. HitSLAT_Right_3_src => hit [HitSLAT_Right_3]
1. HitSLAT_back_src => hit [HitSLAT_back]
1. HitSLAT_front_src => hit [HitSLAT_front]
1. showCamonetHull => user
1. showCamonetCannon => user
1. showCamonetTurret => user
1. showSLATHull => user

- B_AFV_Wheeled_01_up_cannon_F
1. damage_era_front => hit [HitERA_Front]
1. damage_era_top => hit [HitERA_Top]
1. damage_era_left => hit [HitERA_Left]
1. damage_era_right => hit [HitERA_Right]
1. damage_era_back => hit [HitERA_Back]
1. com_gun_reload => reload

- B_APC_Tracked_01_AA_F
1. Missiles_revolving => revolving
1. Missiles_reloadMagazine => reloadMagazine
1. muzzle_rot => ammorandom
1. cannon_35mm_revolving => revolving
1. showCamonetPlates1 => user
1. showCamonetPlates2 => user
1. showCamonetTurret => user
1. showCamonetHull => user
1. showBags => user
...
1. muzzle_rot => ammorandom
1. muzzle_hide => reload
1. MovePlow => user
1. revolving_mg => revolving
1. showCamonetPlates1 => user
1. showCamonetPlates2 => user
1. showAmmobox => user
1. showWheels => user
...
1. muzzle_rot => ammorandom
1. muzzle_hide => reload
1. revolving_hmg => revolving
1. revolving_gmg => revolving
1. showCamonetPlates1 => user
1. showCamonetPlates2 => user
1. showCamonetHull => user
1. showBags => user
...
1. HitSLAT_back_src => hit [HitSLAT_back]
1. HitSLAT_front_src => hit [HitSLAT_front]
1. HitSLAT_top_back_src => hit [HitSLAT_top_back]
1. HitSLAT_top_right_src => hit [HitSLAT_top_right]
1. HitSLAT_top_left_src => hit [HitSLAT_top_left]
1. showBags => user
1. showCamonetHull => user
1. showCamonetCannon => user
1. showCamonetTurret => user
1. showSLATHull => user
1. showSLATTurret => user
...
1. muzzle2_source_rot => ammorandom
1. ReloadAnim => reload
1. ReloadMagazine => reloadmagazine
1. Revolving => revolving
...
1. Gun_VRot => user
1. Minigun => revolving
1. Muzzle_flash => ammorandom
1. Minigun2 => revolving
1. Muzzle_flash2 => ammorandom
...
1. Unarmed_Codriver_Turret_Hide => Proxy
1. Unarmed_Ammo_Hide => Proxy
1. Unarmed_Rear_Cage_Hide => Proxy
...
1. Hide_Shield => user
1. Hide_Rail => user
1. muzzle_source => reload
1. muzzle_source_rot => ammorandom
1. ReloadAnim => reload
1. ReloadMagazine => reloadmagazine
1. Revolving => revolving
...
1. HideServices
1. BeaconsStart
1. BeaconsServicesStart
1. ReloadAnim => reload
1. ReloadMagazine => reloadmagazine
1. Revolving => revolving
1. muzzle_rot_MG => ammorandom
1. muzzle_hide_MG => reload
1. Hide_Shield => user
1. Hide_Rail => user
...
1. BeaconsStart
1. BeaconsServicesStart
1. SPG9_reloadmagazine => reloadmagazine
1. SPG9_reload => reload

- B_G_Offroad_01_F
- B_G_Offroad_01_repair_F
1. HideBumper1 => Proxy
1. HideBumper2 => Proxy
1. hideConstruction => Proxy
1. HideBackpacks => Proxy
1. hidePolice
1. HideServices
1. BeaconsStart
1. BeaconsServicesStart
...
1. HitRFWheel => hit [HitRFWheel]
1. HitLBWheel => hit [HitLF2Wheel]
1. HitRBWheel => hit [HitRF2Wheel]
1. HitLF2Wheel => hit [HitLBWheel]
1. HitRF2Wheel => hit [HitRBWheel]
1. HitLMWheel => hit [HitLMWheel]
1. HitRMWheel => hit [HitRMWheel]
1. HitGlass1 => hit [HitGlass1]
1. HitGlass2 => hit [HitGlass2]
1. HitGlass3 => hit [HitGlass3]
1. HitGlass4 => hit [HitGlass4]
1. HitGlass5 => hit [HitGlass5]
1. HitGlass6 => hit [HitGlass6]
...
1. Door_2_source => door
1. Door_3_source => door
1. Door_4_source => door
1. Hide_Door_1_source => user
1. Hide_Door_2_source => user
1. Hide_Door_3_source => user
1. Hide_Door_4_source => user
1. lights_em_hide => user
1. ladder_hide => user
1. spare_tyre_holder_hide => user
1. spare_tyre_hide => user
1. reflective_tape_hide => user
1. roof_rack_hide => user
1. LED_lights_hide => user
1. sidesteps_hide => user
1. rearsteps_hide => user
1. side_protective_frame_hide => user
1. front_protective_frame_hide => user
1. beacon_front_hide => user
1. beacon_rear_hide => user
1. Hide_Dashboard => user
1. HitGlass1 => hit [HitGlass1]
1. HitGlass2 => hit [HitGlass2]
1. HitGlass3 => hit [HitGlass3]
...
1. HitGlass5 => hit [HitGlass5]
1. HitGlass6 => hit [HitGlass6]
1. HitGlass7 => hit [HitGlass7]
1. HitGlass8 => hit [HitGlass8]
...
1. hidePolice => user
1. HideServices => Proxy
1. BeaconsServicesStart
1. HideCover => door
1. StartBeaconLight => user
1. HideRoofRack => user
1. HideLoudSpeakers => user
1. HideAntennas => user
1. HideBeacon => user
1. HideSpotlight => user
1. HideCoverTailGate => user
1. HideDoor3 => Proxy
1. OpenDoor3 => door
1. Wheel_1_1_damper => damper
1. Wheel_2_1_damper => damper
1. gunner_lf_turn => gunner_lf_turn
1. gunner_rf_turn => gunner_rf_turn
...
1. HitHRotor_source => hit [HitHRotor]
1. HitVRotor_source => hit [HitVRotor]
1. Door_R_source => door
1. Door_L_source => door
1. Door_rear_source => door
...
1. Door_4_source => door
1. Door_5_source => door
1. Door_6_source => door
...
1. Doors => user
1. Proxy => user
1. mainMuzzle_rot => ammorandom
1. mainMuzzle_reload => reload
1. mainMuzzle_revolving => revolving
1. mainMuzzle_reloadMagazine => reloadMagazine
1. codRiverMuzzle_rot => ammorandom
1. codRiverMuzzle_reload => reload
1. codRiverMuzzle_revolving => revolving
1. codRiverMuzzle_reloadMagazine => reloadMagazine
...
1. TitanMuzzle_reload => reload
1. TitanMuzzle_revolving => revolving
1. TitanMuzzle_reloadMagazine => reloadMagazine
...
1. muzzle_hide_arty => reload
1. muzzle_rot_HMG => ammorandom
1. muzzle_hide_HMG => reload
1. muzzle_rot_GMG => ammorandom
1. muzzle_hide_GMG => reload
1. HitComTurret_src => hit [HitComTurret]
1. showCanisters => user
1. showCamonetTurret => user
1. showAmmobox => user
...
- B_MBT_01_mlrs_F
1. Missiles_revolving => revolving
1. muzzle_hide_missiles => reload

- B_MBT_01_TUSK_F
1. muzzle_hide_cannon => reload
1. muzzle_rot_cannon => ammorandom
1. muzzle_rot_cmdr => ammorandom
1. recoil_source => reload
1. commander_gun_recoil => reload
1. HitERA_Front_src => hit [HitERA_Front]
1. HitERA_Left_1_src => hit [HitERA_Left_1]
1. HitERA_Left_2_src => hit [HitERA_Left_2]
1. HitERA_Left_3_src => hit [HitERA_Left_3]
1. HitERA_Left_4_src => hit [HitERA_Left_4]
1. HitERA_Right_1_src => hit [HitERA_Right_1]
1. HitERA_Right_2_src => hit [HitERA_Right_2]
1. HitERA_Right_3_src => hit [HitERA_Right_3]
1. HitERA_Right_4_src => hit [HitERA_Right_4]
1. HitERA_Top_Front_src => hit [HitERA_Top_Front]
1. HitERA_Top_Left_src => hit [HitERA_Top_Left]
1. HitERA_Top_Right_src => hit [HitERA_Top_Right]
1. showCamonetCannon => user
1. showCamonetPlates1 => user
1. showCamonetPlates2 => user
1. showCamonetTurret => user
...
1. HitGlass5 => hit [HitGlass5]
1. HitGlass6 => hit [HitGlass6]
1. HitEngine1 => hit [HitEngine1]
1. HitEngine2 => hit [HitEngine2]
1. HitWinch_Source => hit [HitWinch]
...
1. Gatling_30mm_reload => reload
1. Gatling_30mm_revolving => revolving
1. Missile_AA_04_revolving => revolving
1. Missile_AGM_02_revolving => revolving
1. Rocket_04_HE_revolving => revolving
1. Rocket_04_AP_revolving => revolving
1. Bomb_04_revolving => revolving
1. HitAvionics => hit [HitAvionics]
1. Damper_1_source => damper
1. Damper_2_source => damper
1. Damper_3_source => damper
1. Wheel_1_source => wheel
1. Wheel_2_source => wheel
1. Wheel_3_source => wheel
1. HideWeapons => user
1. HideMFD => user
1. canopy_hide => user
1. ejection_seat_hide => user
1. ejection_seat_motion => user

- B_Plane_Fighter_01_Cluster_F
1. muzzle_rot_20mm => ammorandom
1. mfd_ammo_count_source => revolving
1. canopy_hide => user
1. ejection_seat_hide => user
1. ejection_seat_motion => user
1. tailhook => user
1. gear_f_hook_down => user
1. tailhook_door_l => user
1. tailhook_door_r => user
1. pylon_1_hide => user
1. pylon_2_hide => user
1. pylon_3_hide => user
1. pylon_4_hide => user
1. throttle_pilot => user
1. wing_fold_l => user
1. wing_fold_r => user
1. wing_fold_cover_l => user
1. wing_fold_cover_r => user
1. HitAvionics => hit [HitAvionics]
1. HitEngine => hit [HitEngine]
1. HitEngine2 => hit [HitEngine2]
1. Damper_1_source => damper
1. Damper_2_source => damper
1. Damper_3_source => damper
...
1. pylon_6_hide => user
1. HitHull => hit [HitHull]
1. HitFuel => hit [HitFuel]
1. HitFuel2 => hit [HitFuel2]
1. HitAvionics => hit [HitAvionics]
1. HitLAileron => hit [HitLAileron]
1. HitRAileron => hit [HitRAileron]
1. HitLCRudder => hit [HitLCRudder]
1. HitRRudder => hit [HitRRudder]
1. HitLCElevator => hit [HitLCElevator]
1. HitRElevator => hit [HitRElevator]
1. HitEngine => hit [HitEngine]
1. HitEngine2 => hit [HitEngine2]
1. HitGear => hit [HitGear]
1. Damper_front_source => damper
1. Damper_left_source => damper
1. Damper_right_source => damper
1. Wheel_front_source => wheel
1. Wheel_left_source => wheel
1. Wheel_right_source => wheel
...
- B_Radar_System_01_F
1. HitLFWheel => hit [HitLFWheel]
1. HitLBWheel => hit [HitLBWheel]
1. HitRFWheel => hit [HitRFWheel]
1. HitRBWheel => hit [HitRBWheel]
1. HitTurret => hit [HitTurret]
1. HitHull => hit [HitHull]
...
1. Door_1_source => door
1. Gatling_barrels_source => revolving
1. Gatling_muzzleflash_source => reload
1. Cannon_barrel_source => revolving
1. Cannon_muzzleflash_source => reload
1. Howitzer_muzzleflash_source => reload
...
1. tailhook => user
1. tailhook_door_l_1 => user
1. tailhook_door_l_2 => user
1. tailhook_door_r_1 => user
1. tailhook_door_r_2 => user
1. wing_fold_l_arm => user
1. wing_fold_l => user
1. wing_fold_cover_l_arm => user
1. wing_fold_cover_l => user
1. wing_fold_r_arm => user
1. wing_fold_r => user
1. wing_fold_cover_r_arm => user
1. wing_fold_cover_r => user
1. CollisionLightRed1_source => MarkerLight
1. Damper_1_source => damper
1. Damper_2_source => damper
1. Damper_3_source => damper
1. Wheel_1_source => wheel
...
1. lights_em_hide => user
1. LED_lights_hide => user
1. Utility_drone => user
1. Antimine_drone => user
...
- Box_EAF_Ammo_F
1. Ammo_source => user
1. AmmoOrd_source => user
1. Grenades_source => user
1. Support_source => user
...
1. PositionLightGreen_source => MarkerLight
...
1. FLIR_VRot => user
1. AddBenches => user
1. AddHoldingFrame => user
1. BenchL_Up => user
1. BenchR_Up => user
1. BenchL_Up_instant => user
1. BenchR_Up_instant => user
1. AddDoors => user
1. AddBackseats => user
1. AddTread => user
1. DoorL_Front_Open => user
1. DoorR_Front_Open => user
1. DoorL_Back_Open => user
1. DoorR_Back_Open => user
...
1. HitGlass7 => hit [HitGlass7]
1. HitGlass8 => hit [HitGlass8]
1. HitGlass9 => hit [HitGlass9]
1. HitGlass10 => hit [HitGlass10]
1. HitGlass11 => hit [HitGlass11]
1. HitGlass12 => hit [HitGlass12]
1. HitGlass13 => hit [HitGlass13]
1. HitGlass14 => hit [HitGlass14]
1. HitGlass15 => hit [HitGlass15]
1. HitGlass16 => hit [HitGlass16]
1. HitGlass17 => hit [HitGlass17]
...
1. Door_3_source => door
1. hideLeftDoor => user
1. hideRightDoor => user
1. hideRearDoor => user
1. hideBullbar => user
1. hideFenders => user
1. hideHeadSupportRear => user
1. hideHeadSupportFront => user
1. hideRollcage => user
1. hideSeatsRear => user
1. hideSpareWheel => user
1. LMG_revolving => revolving
1. LMG_reload => reload
1. LMG_reloadmagazine => reloadmagazine
1. LMG_muzzle_rot => ammorandom
1. SPG9_reloadmagazine => reloadmagazine
1. SPG9_reload => reload
...
1. Wheel_2_source => wheel
1. Wheel_3_source => wheel
1. Hit_Avionics => hit [HitAvionics]
...
1. Leg_2_Move_Source => user
1. Leg_3_Move_Source => user
1. Leg_4_Move_Source => user
1. Panel_1_Rotate_Source => user
1. Panel_2_Rotate_Source => user
1. Panel_3_Rotate_Source => user
1. Panel_4_Rotate_Source => user
1. Panel_1_Hide_Source => user
1. Panel_2_Hide_Source => user
1. Panel_3_Hide_Source => user
1. Panel_4_Hide_Source => user
...
1. Sprinkler_2_move => user
1. Sprinkler_3_move => user
1. Hide_Mist_Source => user
1. Sprinkler_4_hide => user
1. valve_source => user
...
1. Door_1_noSound_source => user
1. Door_1_locked_source => user
...
1. muzzle_hide => reload
1. HideTurret => user
1. autocannon_30mm_revolving => revolving
1. Smoke_source => revolving
1. HitEngine_src => hit [HitEngine]
1. HitFuel_src => hit [HitFuel]
1. HitHull_src => hit [HitHull]
1. HitMainGun_src => hit [HitGun]
...
1. GunR_Revolving => revolving
1. muzzle_hide => reload
1. Muzzle_Flash => ammorandom
1. Missiles_revolving => revolving
1. RocketPods_Hide => user
1. HideWeapons => user
1. HitGlass1 => hit [HitGlass1]
1. HitGlass2 => hit [HitGlass2]
1. HitGlass3 => hit [HitGlass3]
...
- I_MBT_03_cannon_F
1. muzzle_rot_cannon => ammorandom
1. muzzle_rot_coax => ammorandom
1. muzzle_rot_hmg => ammorandom
1. muzzle_hide_coax => reload
1. recoil_source => reload
1. LockMuzzle => user
1. HitEngine_src => hit [HitEngine]
1. HitFuel_src => hit [HitFuel]
...
1. HitComTurret_src => hit [HitComTurret]
1. Smoke_source => revolving
1. HitSLAT_Left_src => hit [HitSLAT_Left]
1. HitSLAT_Right_src => hit [HitSLAT_Right]
1. HitSLAT_back_src => hit [HitSLAT_back]
1. HitSLAT_front_src => hit [HitSLAT_front]
1. HitSLAT_top_left_src => hit [HitSLAT_top_left]
1. HitSLAT_top_right_src => hit [HitSLAT_top_right]
...
1. AddGbu12 => user
1. AddZephyr => user
1. AddAsraam_out => user
1. AddAsraam_mid => user
...
1. Door_1_noSound_source => user
1. Door_1_locked_source => user
1. Door_2_sound_source => user
1. Door_2_noSound_source => user
1. Door_2_locked_source => user
1. Door_3_sound_source => user
1. Door_3_noSound_source => user
1. Door_3_locked_source => user
1. Glass_1_source => hit [Glass_1_hitpoint]
1. Glass_2_source => hit [Glass_2_hitpoint]
1. Glass_3_source => hit [Glass_3_hitpoint]
1. Glass_4_source => hit [Glass_4_hitpoint]
1. Glass_5_source => hit [Glass_5_hitpoint]
1. Glass_6_source => hit [Glass_6_hitpoint]
1. Glass_7_source => hit [Glass_7_hitpoint]
1. Glass_8_source => hit [Glass_8_hitpoint]
1. Glass_9_source => hit [Glass_9_hitpoint]
1. Glass_10_source => hit [Glass_10_hitpoint]
1. Glass_11_source => hit [Glass_11_hitpoint]
1. Glass_12_source => hit [Glass_12_hitpoint]
1. Glass_13_source => hit [Glass_13_hitpoint]
1. Glass_14_source => hit [Glass_14_hitpoint]
1. Glass_15_source => hit [Glass_15_hitpoint]
1. Glass_16_source => hit [Glass_16_hitpoint]
1. Glass_17_source => hit [Glass_17_hitpoint]
1. Glass_18_source => hit [Glass_18_hitpoint]
1. Glass_19_source => hit [Glass_19_hitpoint]
1. Glass_20_source => hit [Glass_20_hitpoint]
1. Glass_21_source => hit [Glass_21_hitpoint]
1. Glass_22_source => hit [Glass_22_hitpoint]
...
1. Glass_21_source => hit [Glass_21_hitpoint]
1. Glass_22_source => hit [Glass_22_hitpoint]
1. Glass_23_source => hit [Glass_23_hitpoint]
1. Glass_24_source => hit [Glass_24_hitpoint]
1. Glass_25_source => hit [Glass_25_hitpoint]
1. Glass_26_source => hit [Glass_26_hitpoint]
1. Glass_27_source => hit [Glass_27_hitpoint]
1. Glass_28_source => hit [Glass_28_hitpoint]
1. Glass_29_source => hit [Glass_29_hitpoint]
1. Glass_30_source => hit [Glass_30_hitpoint]
1. Glass_31_source => hit [Glass_31_hitpoint]
1. Glass_32_source => hit [Glass_32_hitpoint]
...
1. Door_3_noSound_source => user
1. Door_3_locked_source => user
1. Door_4_sound_source => user
1. Door_4_noSound_source => user
1. Door_4_locked_source => user
1. Door_5_sound_source => user
1. Door_5_noSound_source => user
1. Door_5_locked_source => user
1. Door_6_sound_source => user
1. Door_6_noSound_source => user
1. Door_6_locked_source => user
1. Door_7_sound_source => user
1. Door_7_noSound_source => user
1. Door_7_locked_source => user
1. Door_8_sound_source => user
1. Door_8_noSound_source => user
1. Door_8_locked_source => user
1. Glass_33_source => hit [Glass_33_hitpoint]
1. Glass_34_source => hit [Glass_34_hitpoint]
1. Glass_35_source => hit [Glass_35_hitpoint]
1. Glass_36_source => hit [Glass_36_hitpoint]
1. Glass_37_source => hit [Glass_37_hitpoint]
1. Glass_38_source => hit [Glass_38_hitpoint]
1. Glass_39_source => hit [Glass_39_hitpoint]
1. Glass_40_source => hit [Glass_40_hitpoint]
1. Glass_41_source => hit [Glass_41_hitpoint]
1. Glass_42_source => hit [Glass_42_hitpoint]
1. Glass_43_source => hit [Glass_43_hitpoint]
1. Glass_44_source => hit [Glass_44_hitpoint]
1. Glass_45_source => hit [Glass_45_hitpoint]
1. Glass_46_source => hit [Glass_46_hitpoint]
1. Glass_47_source => hit [Glass_47_hitpoint]
1. Glass_48_source => hit [Glass_48_hitpoint]
1. Glass_49_source => hit [Glass_49_hitpoint]
1. Glass_50_source => hit [Glass_50_hitpoint]
1. Glass_51_source => hit [Glass_51_hitpoint]
1. Glass_52_source => hit [Glass_52_hitpoint]
1. Glass_53_source => hit [Glass_53_hitpoint]
1. Glass_54_source => hit [Glass_54_hitpoint]
1. Glass_55_source => hit [Glass_55_hitpoint]
1. Glass_56_source => hit [Glass_56_hitpoint]
1. Glass_57_source => hit [Glass_57_hitpoint]
1. Glass_58_source => hit [Glass_58_hitpoint]
1. Glass_59_source => hit [Glass_59_hitpoint]
1. Glass_60_source => hit [Glass_60_hitpoint]
1. Glass_61_source => hit [Glass_61_hitpoint]
...
1. CoreChunk2 => hit [HitZone2]
1. CoreChunk3 => hit [HitZone3]
1. CoreChunk4 => hit [HitZone4]
1. CoreChunk5 => hit [HitZone5]
1. CoreChunk6 => hit [HitZone6]
1. CoreChunk7 => hit [HitZone7]
1. CoreChunk8 => hit [HitZone8]
1. CoreChunk9 => hit [HitZone9]
1. CoreChunk10 => hit [HitZone10]
...
1. Retract => user
1. Biomineralization_HP1 => user
1. Biomineralization_HP2 => user
...
1. Door_8_noSound_source => user
1. Door_8_locked_source => user
1. Door_9_sound_source => user
1. Door_9_noSound_source => user
1. Door_9_locked_source => user
1. Door_10_sound_source => user
1. Door_10_noSound_source => user
1. Door_10_locked_source => user
1. Door_11_sound_source => user
1. Door_11_noSound_source => user
1. Door_11_locked_source => user
1. Door_12_sound_source => user
1. Door_12_noSound_source => user
1. Door_12_locked_source => user
1. Door_13_sound_source => user
1. Door_13_noSound_source => user
1. Door_13_locked_source => user
1. Door_14_sound_source => user
1. Door_14_noSound_source => user
1. Door_14_locked_source => user
1. Door_15_sound_source => user
1. Door_15_noSound_source => user
1. Door_15_locked_source => user
1. Door_16_sound_source => user
1. Door_16_noSound_source => user
1. Door_16_locked_source => user
1. Door_17_sound_source => user
1. Door_17_noSound_source => user
1. Door_17_locked_source => user
1. Door_18_sound_source => user
1. Door_18_noSound_source => user
1. Door_18_locked_source => user
1. Door_19_sound_source => user
1. Door_19_noSound_source => user
1. Door_19_locked_source => user
1. Door_20_sound_source => user
1. Door_20_noSound_source => user
1. Door_20_locked_source => user
1. Door_21_sound_source => user
1. Door_21_noSound_source => user
1. Door_21_locked_source => user
1. Door_22_sound_source => user
1. Door_22_noSound_source => user
1. Door_22_locked_source => user
1. Glass_1_source => hit [Glass_1_hitpoint]
1. Glass_2_source => hit [Glass_2_hitpoint]
1. Glass_3_source => hit [Glass_3_hitpoint]
1. Glass_4_source => hit [Glass_4_hitpoint]
...
1. Glass_60_source => hit [Glass_60_hitpoint]
1. Glass_61_source => hit [Glass_61_hitpoint]
1. Glass_62_source => hit [Glass_62_hitpoint]
...
1. Hatch_1_source => user
1. Hatch_2_source => user
1. Hatch_3_source => user
1. Hatch_4_source => user
...
1. Hatch_3_source => user
1. Hatch_4_source => user
1. Hatch_5_source => user
1. Hatch_6_source => user
...
1. Platform_source_2 => user
1. Platform_source_3 => user
...
1. Deflector_2 => user
1. Deflector_2_hydraulic_1 => user
1. Deflector_2_hydraulic_2 => user
1. Deflector_2_hydraulic_3 => user

- Land_Carrier_01_hull_04_2_F
1. Deflector_1 => user
1. Deflector_1_hydraulic_1 => user
1. Deflector_1_hydraulic_2 => user
1. Deflector_1_hydraulic_3 => user
...
1. Deflector_3 => user
1. Deflector_3_hydraulic_1 => user
1. Deflector_3_hydraulic_2 => user
1. Deflector_3_hydraulic_3 => user
1. Deflector_4 => user
1. Deflector_4_hydraulic_1 => user
1. Deflector_4_hydraulic_2 => user
1. Deflector_4_hydraulic_3 => user
...
1. Door_2_source => user
1. Door_3_source => user
...
1. Door_1_source => user
1. Door_2_source => user
1. Glass_1_source => user
1. Glass_2_source => user
1. Glass_3_source => user
1. Glass_4_source => user
1. Glass_5_source => user
1. Glass_6_source => user
1. Glass_7_source => user
1. Glass_8_source => user
1. Glass_9_source => user
1. Glass_10_source => user
1. Glass_11_source => user
1. Glass_12_source => user
1. Glass_13_source => user
1. Glass_14_source => user
1. Glass_15_source => user
1. Glass_16_source => user
1. Glass_17_source => user
1. Glass_18_source => user

- Land_Destroyer_01_hull_03_F
- Land_Destroyer_01_hull_04_F
1. Door_1_source => user
1. Door_Hangar_1_1_open => user
1. Door_Hangar_1_2_open => user
1. Door_Hangar_1_3_open => user
1. Door_Hangar_2_1_open => user
1. Door_Hangar_2_2_open => user
1. Door_Hangar_2_3_open => user
...
1. Hitzone_2_source => hit [Hitzone_2_hitpoint]
1. Door_1_sound_source => user
1. Door_1_noSound_source => user
1. Door_1_locked_source => user
1. Door_2_sound_source => user
...
1. Door_1_sound_source => userPositionHashedInit
1. Door_1_locked_source => user
1. Door_2_sound_source => userPositionHashedInit
1. Door_2_locked_source => user
...
1. Segment_1_source => user
1. Segment_2_source => user
1. Segment_3_source => user

- Land_PlasticBarrier_01_line_x6_F
1. Segment_1_source => user
1. Segment_2_source => user
1. Segment_3_source => user
1. Segment_4_source => user
1. Segment_5_source => user
...
1. Drawer_1_move_source => user
1. Drawer_2_move_source => user
1. Drawer_3_move_source => user
1. Drawer_4_move_source => user
1. Drawer_5_move_source => user
1. Drawer_6_move_source => user
1. Drawer_1_hide_source => user
1. Drawer_2_hide_source => user
1. Drawer_3_hide_source => user
1. Drawer_4_hide_source => user
1. Drawer_5_hide_source => user
1. Drawer_6_hide_source => user
...
1. Drawer_5_move_source => user
1. Drawer_6_move_source => user
1. Lid_1_hide_source => user
1. Lid_2_hide_source => user
1. Wing_L_Hide_Source => user
1. Wing_R_Hide_Source => user
...
1. Light_2_pitch_source => user
1. Light_2_yaw_source => user
1. Light_2_extend_source => user
...
1. Light_2_extend_source => user
1. Light_3_pitch_source => user
1. Light_3_yaw_source => user
1. Light_3_extend_source => user
1. Light_4_pitch_source => user
1. Light_4_yaw_source => user
1. Light_4_extend_source => user
...
1. Server_Hide_Source => user
1. Lights_Off_Source => user
...
1. WhiteLight_Hide => user
1. Level_Crossing_Barrier => user
...
1. Top_Hide => user
1. Top_Poles_Hide => user
1. Stand_Hide => user
1. Stand_Poles_Hide => user
...
1. Stand_Poles_Hide => user
1. Crouch_Hide => user
1. Crouch_Poles_Hide => user
1. Prone_Hide => user
1. Prone_Poles_Hide => user
...
1. Top_Hide => user
1. Top_Poles_Hide => user
1. Top_Panel_Left_Hide => user
1. Top_Panel_Right_Hide => user
1. Stand_Poles_Hide => user
1. Stand_Panel_Left_Hide => user
1. Stand_Panel_Right_Hide => user
1. Crouch_Hide => user
...
1. Top_Panel_Left_Hide => user
1. Stand_Panel_Left_Hide => user
1. Crouch_Panel_Left_Hide => user
1. Prone_Panel_Left_Hide => user
1. Top_Panel_Right_Hide => user
1. Stand_Panel_Right_Hide => user
1. Crouch_Panel_Right_Hide => user
1. Prone_Panel_Right_Hide => user
...
1. L_Top_Hide => user
1. L_Top_Poles_Hide => user
1. L_Stand_Hide => user
1. L_Stand_Poles_Hide => user
1. R_Top_Hide => user
1. R_Top_Poles_Hide => user
1. R_Stand_Hide => user
1. R_Stand_Poles_Hide => user
...
1. L_Stand_Hide => user
1. L_Stand_Poles_Hide => user
1. L_Crouch_Hide => user
1. L_Crouch_Poles_Hide => user
1. L_Prone_Hide => user
1. L_Prone_Poles_Hide => user
1. R_Top_Hide => user
1. R_Top_Poles_Hide => user
1. R_Stand_Hide => user
1. R_Stand_Poles_Hide => user
1. R_Crouch_Hide => user
1. R_Crouch_Poles_Hide => user
1. R_Prone_Hide => user
1. R_Prone_Poles_Hide => user
...
1. Hitzone_1_source => hit [Hitzone_1_hitpoint]
1. Hitzone_2_source => hit [Hitzone_2_hitpoint]
1. Hitzone_3_source => hit [Hitzone_3_hitpoint]
1. Door_1_sound_source => user
1. Door_1_noSound_source => user
1. Door_1_locked_source => user
1. Door_2_sound_source => user
...
1. Hitzone_2_source => hit [Hitzone_2_hitpoint]
1. Hitzone_3_source => hit [Hitzone_3_hitpoint]
1. Hitzone_4_source => hit [Hitzone_4_hitpoint]
...
1. Panels_Yaw => user
1. Panel_1_Pitch => user
1. Panel_2_Pitch => user
...
1. Plate_2_source => user
1. Plate_3_source => user
1. Plate_4_source => user
1. Plate_5_source => user
1. Plate_6_source => user

- Land_Target_Line_01_F
- Land_Target_Line_PaperTargets_01_F
- Land_Target_Oval_F
1. Ground_holder_hide => user
1. Pole_Left_Hide => user
1. Pole_Right_Hide => user
1. Pole_Top_Hide => user
1. Pole_Bottom_Hide => user
1. Left_Rotate
1. Right_Rotate
1. Top_Rotate
1. Bottom_Rotate
1. Pole_Rotate
1. Target_Left_Rotate
1. Target_Right_Rotate
1. Target_Top_Rotate
1. Target_Bottom_Rotate
1. Target_Pole_Rotate
...
1. Popup_source => user
1. Stand_source => user
1. Swivel_1rpm_source => user
1. Swivel_2rpm_source => user
1. Swivel_3rpm_source => user
1. Swivel_4rpm_source => user
1. Swivel_5rpm_source => user
1. Swivel_6rpm_source => user
1. Swivel_10rpm_source => user
1. Swivel_12rpm_source => user
1. Swivel_15rpm_source => user
...
1. VoronaMuzzle_reload => reload
1. VoronaMuzzle_revolving => revolving
1. VoronaMuzzle_reloadMagazine => reloadMagazine
...
1. HitTurret_src => hit [HitTurret]
1. HitComTurret_src => hit [HitComTurret]
1. HitLTrack_src => hit [HitLTrack]
1. HitRTrack_src => hit [HitRTrack]
1. HitERA_Front_src => hit [HitERA_Front]
1. HitERA_Left_1_src => hit [HitERA_Left_1]
1. HitERA_Left_2_src => hit [HitERA_Left_2]
1. HitERA_Right_1_src => hit [HitERA_Right_1]
1. HitERA_Right_2_src => hit [HitERA_Right_2]
1. HitERA_Top_Left_1_src => hit [HitERA_Top_Left_1]
1. HitERA_Top_Left_2_src => hit [HitERA_Top_Left_2]
1. HitERA_Top_Right_1_src => hit [HitERA_Top_Right_1]
1. HitERA_Top_Right_2_src => hit [HitERA_Top_Right_2]
1. driver_fan_unhide => User
1. driver_fan_hide => User
1. showCamonetHull => user
1. showCamonetCannon => user
1. showCamonetTurret => user
1. showLog => user
...
1. damage_era_front => hit [HitERA_Front]
1. damage_era_top => hit [HitERA_Top]
1. damage_era_left1 => hit [HitERA_Left_1]
1. damage_era_left2 => hit [HitERA_Left_2]
1. damage_era_right1 => hit [HitERA_Right_1]
1. damage_era_right2 => hit [HitERA_Right_2]
1. HitSLAT_l_src => hit [HitSLAT_Left]
1. HitSLAT_r_src => hit [HitSLAT_Right]
1. LockMuzzle => user
1. showCamonetCannon => user
1. showCamonetHull => user
1. showCamonetTurret => user
...
1. Cannon_30mm_revolving => revolving
1. Missile_AA_03_revolving => revolving
1. Missile_AGM_01_revolving => revolving
1. Rocket_03_HE_revolving => revolving
1. Rocket_03_AP_revolving => revolving
1. Bomb_03_revolving => revolving
1. Damper_1_source => damper
1. Damper_2_source => damper
1. Damper_3_source => damper
1. Wheel_1_source => wheel
...
1. Door_1_source => door
1. Hide_Cargoseats_source => user
1. Rockets_revolving_source => revolving
1. Missiles_revolving_source => revolving
1. Cannon_revolving_source => revolving
1. Cannon_muzzleflash_source => reload
1. Wheel_1_source => wheel
1. Wheel_2_source => wheel
1. Wheel_3_source => wheel
...
1. HitGlass16 => hit [HitGlass16]
1. HitGlass17 => hit [HitGlass17]
1. HitGlass18 => hit [HitGlass18]
1. HitGlass19 => hit [HitGlass19]
1. HitGlass20 => hit [HitGlass20]
1. HideWeapons => user
...
1. Drawer_1_key_source => user
1. Drawer_2_source => user
...
1. Arrow02_Rotate => user
1. Arrow03_Rotate => user
1. Arrow04_Rotate => user
1. Arrow05_Rotate => user
1. Arrow06_Rotate => user
1. Arrow07_Rotate => user
1. Arrow08_Rotate => user
1. Arrow01_Fide => user
1. Arrow02_Fide => user
1. Arrow03_Fide => user
1. Arrow04_Fide => user
