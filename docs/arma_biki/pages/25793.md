...
**This gear is primarily cosmetic; limited features are only available in the context of Contact's campaign and gameplay.*
...
|freefeature1= **Additional Multiplayer Scenarios** – Jump into Arma 3’s official Zeus Game Master, Combat Patrol, and Warlords multiplayer modes with additional scenarios for the new Livonia terrain.
...
|start5= [Official Website](https://arma3.com/contact)
|start6= [Contact on Steam](https://store.steampowered.com/app/1021790/Arma_3_Contact/)
|isDLC= y
}}
