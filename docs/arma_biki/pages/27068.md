## Arma 3: Scripted Database

- Source: https://community.bistudio.com/wiki/Arma_3:_Scripted_Database
- Revision: 376300
- Updated: 2025-10-03T15:35:17Z

{{TOC|side}}
For better peformance (faster access and write speeds) you can use HashMaps instead.|arma3|2.02|

A Scripted Database is a simple way to manage information with ingame functions from bi and has been introduced in {{tkoh}}.
...
A list of all functions which are used to operate the database can be found here: Database functions.
...
The most straightforward option. Simply add

```sqf
TAG_database = [];
```

 to any script where you want to declare the database, eg initServer.sqf.
