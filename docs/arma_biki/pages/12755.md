...
thumb|400px|The ORBAT Group module
### ORBAT Group Module
...
Writing the direct path is not possible in a `CfgORBAT` defined in Description.ext (as the mission changes path on different computers);
...
Listed in ["Strategic" function group](Category:Function Group: Strategic):
{{Columns|2|
