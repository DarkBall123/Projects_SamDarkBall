...
- Revision: 363309
- Updated: 2024-03-26T11:43:30Z

{{TOC|side}}
128px
1.24

The purpose of this tools is to publish and manage items in the Steam Workshop. It allows you to upload your mods and change the information that is displayed on their Steam Workshop page.
...
Based on the selected item type, you can choose from the multiple tags that are used on [Steam|text= Workshop](link= http://steamcommunity.com/app/107410/workshop/) to filter the items.
...
Checkbox - Before publishing, each author must explicitly agree with [text= SteamWorks license](link= http://steamcommunity.com/sharedfiles/workshoplegalagreement). The whole text of the license is available online.
...
- Temp folder path: define a temporary folder where mods with multiple files are copied and prepared before their publishing. Provide an absolute path or use [...]  to open the Open folder dialog. Contents of the folder is deleted after a successful publishing.
  ...
  - When adding files, a new folder is created in *Temp* with the **Name** of the mod (example: *...\Temp\MyFirstMod* ). When such folder already exists, the new folder cannot be created and publishing fails with error. Please, remove such folder manually before retrying.Copying large or multiple files between drives can take longer.
...
##### Other buttons
- [Bohemia Interactive](http://www.bistudio.com/) - opens company page in external web browser
- {{Link|http://steamcommunity.com/workshop/browse/?appid{{=}}107410|Workshop}} - open Arma 3 workshop page in external browser
- [Support](http://support.bistudio.com/arma-3) - open bi support page in external browser
- [Feedback](http://feedback.arma3.com) - opens feedback tracker, Arma 3's community feedback and issue tracking service in external web browser
...
When something goes wrong (in several attempts, because Steam can have a bad moment sometimes :) ), please, create an issue on the [tracker](http://feedback.arma3.com feedback) in *Tools* category and include these logs.
