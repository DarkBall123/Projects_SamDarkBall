...
### b.) Mission (Large)
100px|thumb|Mission symbol example
...
250px|thumb|National Emblem Template. Note the mirrored extra item.
...
##### Marking
thumbnail|400px|A civilian P601 marked up.
...
### Tactical Sign
thumb|200px|Template image for custom NATO tactical signs.
...
thumbnail|200px|Template for custom license plate background.
...
This will cause the given vehicle to be created by default with the

```
myMOD_insignia_aaf_01
```
