...
- Revision: 373634
- Updated: 2025-05-30T04:22:09Z

{{TOC|side}}
**This is an early version of a character model making tutorial for Arma 3 Alpha. It still relies on the old {{arma2}} tools and only limited example models are provided - may be expanded in the future.**

Please be aware of the Arma 3: Modding License.

##### Requirements
- https://store.steampowered.com/app/233800/Arma_3_Tools (object builder, requires a copy of Arma 3)
- https://store.steampowered.com/app/390500/Arma_3_Samples (all modding examples, requires a copy of Arma 3)
- Blender with the Arma 3 Toolbox addon

##### Other useful material
**Arma 3 specific**
- [text= Stiltman's excellent guide to existing Arma3 character **retexturing**](link= http://forums.bistudio.com/showthread.php?148130-Arma3-Characters-Modding-Tutorial&p=2324469&viewfull=1#post2324469)
- [text= Mondkalb's fully implemented new units](link= http://forums.bistudio.com/showthread.php?148650-Old-stlye-US-Army-BDU) (this [license](http://creativecommons.org/licenses/by-nc-sa/3.0/) applies) [2](http://www.armaholic.net/chili/addons/units/mbg_old_usarmy_mlod.7z)
- [text= Bad Benson's description on how to export characters from Maya](link= http://forums.bistudio.com/showthread.php?148130-Arma3-Characters-Modding-Tutorial&p=2320156&viewfull=1#post2320156)
- [text= Example vest config by RavenDK](link= http://forums.bistudio.com/showthread.php?148130-Arma3-Characters-Modding-Tutorial&p=2322957&viewfull=1#post2322957)
- [text= Character retexture guide by Scarecrow398](link= http://forums.bistudio.com/showthread.php?148130-Arma3-Characters-Modding-Tutorial&p=2331073&viewfull=1#post2331073)
- [text= Underwear modding guidelines by pomigit](link= http://forums.bistudio.com/showthread.php?166612-ARMA-3-Underwear-modding-guidelines)
- [text= Modders resource: New animation workflow!](link= http://forums.bistudio.com/showthread.php?167944-Modders-resource-New-animation-workflow!)

**{{arma2}} / {{arma1}} / {{ofp}} / general**
- Mondkalb's Addon Making Tutorial for Arma2 (updated version for Arma3 hopefully coming soon)
- [text= STALKERGB's Weighting overview](link= http://forums.bistudio.com/showthread.php?114036-STALKERGB-s-Weighting-overview) (creating skin directly in in Oxygen2)
...
### Porting existing {{arma2}} characters into Arma 3

*This is for experienced people who already know how to create a character for {{arma2}}, and have their models ready in unbinarized p3d format. Unfortunately, binarized p3d models, like {{arma2}} addons content, cannot be converted for Arma 3*
- open two Oxygens, one with the template scene A3_character_template.p3d, and one with the {{arma2}} character you want to port
- select only the visual mesh of the {{arma2}} character (only the physical mesh of the actual character, nothing else) and copy-paste it into corresponding LODs in the Arma 3 template. Discard all {{arma2}} proxies and technical LODs, only copy the visual mesh and mesh from ShadowVolume 0.00.
- If bare skin is present (typically hands or head) then discard the {{arma2}} mesh, and replace with Arma 3 parts (included in template). In O2, even the skinned mesh can be freely copy-pasted without trouble.
...
*COMING SOON*
- meanwhile check [Mondkalb's example character addon structure and configs](http://www.armaholic.net/chili/addons/units/mbg_old_usarmy_mlod.7z), and try to mimic its structure. (or overwrite his models if you are afraid of touching config files)
- some knowledge can be found here (most still applies in A3)[Configuration of Arma1 soldier](http://www.aos.armaholic.eu/tutorial2.html)
