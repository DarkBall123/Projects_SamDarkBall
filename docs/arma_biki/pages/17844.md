...
Since the release of Arma 3, we've had a general overview of how the game is being played, what game mod(e)s are most popular and what people like or dislike.
...
This allows us to know better our players (without actually disturbing them while playing), and thanks to that, to build a better gaming experience.

Along with the 1.56 update, we are introducing game analytics into Arma 3.
...
It's also all anonymous and the data will be used solely for understanding how Arma 3 is being played.
The more data we will gather, the more precisely we will know what you like in the game and how you play it - which in turn will guide us to set our priorities and make the game better for you.
...
Dedicated Server analytics may be disabled simply by using
