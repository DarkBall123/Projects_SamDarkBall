...
- vehicle: Object - transport vehicle
- config: Config - path to config entry containing the expression
...
Arma 3: Sound getSoundController getEnvSoundController getAllEnvSoundControllers getAllSoundControllers getCustomSoundController setCustomSoundController getCustomSoundControllerCount
