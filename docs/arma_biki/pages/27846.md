...
|-
| 6..15
26..65 || Custom Channels || Content will only be available for players which have been assigned to this channel. See radioChannelAdd. || Custom channels can be created on the fly. See radioChannelCreate.
{{Feature|warning|2=
...
See Command Group: Custom Radio and Chat for commands which expect a customChannelID.
