...
- Protocol is named in format *RadioProtocol{{Color|DeepSkyBlue|ISO}}*, where *{{Color|DeepSkyBlue|ISO}}* is [ISO 639-2/B](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code of the faction to which protocol belongs.
