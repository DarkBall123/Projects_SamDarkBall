## Arma 2: Artillery Module

- Source: https://community.bistudio.com/wiki/Arma_2:_Artillery_Module
- Revision: 364690
- Updated: 2024-05-25T17:23:26Z

{{TOC|side|0.9}}
{{Feature|arma2|This guide is about **{{arma2}}**. For Arma 3, see [https://www.youtube.com/watch?v{{=}}uTVhTWPdg1M this Youtube video].}}
...
In arma2oa, synchronisation is not required as all artillery units are synced automatically. To prevent the action showing up for a specific unit, use:
...
1. Immediate smoke - Fire 6 smoke shells.
1. Immediate suppression, Willie Pete - Same as Immediate HE, but with WP.
1. Illumination mission - One flare munition every 10 seconds for 3 minutes.
1. LASER - Fire two laser guided HE shells.
1. SADARM – Stagger three SADARMs ten seconds apart.
1. HE Fire For Effect - Bombard with continuous HE for one minute.
1. WP Fire For Effect – Bombard with continuous WP for one minute.
1. Adjust fire - Fire two HE rounds at the target.
...
1. Put the following in its init field to stop custom missions:

```sqf
this setVariable ["settings", [[], true, nil, nil, false]];
```

1. Link it to your soldier (using F5)
1. Create a trigger with the following **onAct** field:
...
[ArtyDemo_MLRS_SOM.Chernarus.7z - By Headspace](http://www.mediafire.com/?45336qyic56syz9)
...
[ArtyDemo_MLRS_SOM_VIRTUAL.zip - By Headspace](http://dev-heaven.net/attachments/download/865/ArtyDemo_MLRS_SOM_VIRTUAL.zip)
