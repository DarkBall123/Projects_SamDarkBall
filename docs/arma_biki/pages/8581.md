...
- **position**: String - memory point which acts as the centre for the radius check. [May be replaced with named selections (actionNamedSel) in Tac-Ops DLC](https://feedback.bistudio.com/T126930#1649747)
