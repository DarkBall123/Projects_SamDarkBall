...
- Revision: 245899
- Updated: 2021-02-16T18:03:55Z

{{TOC|side}}
The following information **are by no means official**. They were retrieved with some simple tests as described below.
...
The heights listed here are the VR Obstacle objects. They can be used as reference.
...
When two separate building/object walls are 180 cm apart from each other, the AI seems to be able to navigate this corridor (better use 2m in this case though).
...
The tests where conducted with the 1x1x1m VR Block, and the 10x5x4m VR Block. So if their geometry does not properly match these results are slightly inaccurate.
