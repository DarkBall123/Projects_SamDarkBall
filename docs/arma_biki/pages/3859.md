...
- Revision: 349916
- Updated: 2023-11-20T22:11:06Z

{{TOC|side}}

For a proper writing tutorial, see Writing a Function.
...
A **function** contains code which usually consists of an *input*, *processing* and *output* part. Functions were first introduced in the {{ofpr}} patch.
...
Parameters for functions are available to the function via the magic variable _this.
...
frame|right||Function Execution Diagram in Scheduler#Scheduled_Environment|scheduled environment
...
{{Feature|informative|You can still use the special variables and commands of scripts in functions ({{arma1}} only)!}}
