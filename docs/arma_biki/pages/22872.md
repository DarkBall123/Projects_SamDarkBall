...
- Works in both singleplayer 1.78 and multiplayer 1.82 environments.
...
520px|Settings for the 'Civilian Presence' module
...
- **Example:**
- Apply random loadouts from the [text= CUP Units](link= https://steamcommunity.com/sharedfiles/filedetails/?id=497661914) mod to civilians:
- 
...
520px|Settings for 'Civilian Presence Position' module
