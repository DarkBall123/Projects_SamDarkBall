...
|p2= respawnDelay: Number - (Optional since 2.18, default -1) delay in seconds between respawns. (-1 to use 3DEN vehicle respawn delay or *respawnVehicleDelay* from description.ext)
...
|p7since= arma3 2.18
|p8= respawnMode: Number or String - (Optional, default -1) - overrides vehicle respawn mode. Available modes are: 2 or "INSTANT" and 3 or "BASE". -1 use description.ext value.
|p8since= arma3 2.18
