...
- Source: https://community.bistudio.com/wiki/ropeCreate
- Revision: 377047
- Updated: 2026-01-01T08:54:21Z
...
|p1= fromObject: Object - transport where the rope originates and which fly behavior will be affected

|p2= fromPoint: String or Array - position for the rope start, either a memory point String or relative offset Array

|p3= toObject: Object - entity which is automatically attached to the end of the rope
...
|p6= ropeStart: Array with [ropeStartType, ropeStartDownVector] - (Optional, default ["", [0,0,-1]])
...
|p7= ropeEnd: Array with [ropeEndType, ropeEndDownVector] - (Optional, default ["", [0,0,-1]]):
...
|p8= ropeType: String - (Optional, default "Rope") - rope type, `CfgVehicles`' classname
|p8since= arma3 2.06
...
|p21= fromObject: Object - transport where the rope originates and which fly behavior will be affected
...
|p24= ropeStart: Array with [ropeStartType, ropeStartDownVector] - (Optional, default ["", [0,0,-1]])
- ropeStartType: String - type of the rope start (see description)
- ropeStartDownVector: String or Array, either a memory point String or relative vector Array. If String is given, then `ropeStartDownVector` is calculated from `fromPoint` towards `ropeStartDownVector` memory point

|p25= ropeEnd: Array with [ropeEndType, ropeEndDownVector] - (Optional, default ["", [0,0,-1]])
- ropeEndType: String - type of the rope end (see description)
- ropeEndDownVector: Array - relative vector

|p26= ropeType: String - (Optional, default "Rope") - rope type, `CfgVehicles`' classname
|p26since= arma3 2.06
...
|text= Doesn't work well for towing vehicles on the ground.
...
|text= Pay special attention to what is your **fromObject** and what is your **toObject** as this will have an impact on the physics of the rope.
