...
- Array of Objects - Before Arma 3 v2.00 this command did not return roads of type `"ROAD"`, `"MAIN ROAD"`, `"TRACK"`, `"TRAIL"`
...
|text= Large bridges are map type `"ROAD"`. Small foot bridges are not roads and not included into road net.
