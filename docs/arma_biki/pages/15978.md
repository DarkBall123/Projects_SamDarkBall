...
|text= This function is only used for dialogs which have background UAV tiles (See the in game pause menu for example), since this is only really found in official dialogs documentation on this function doesn't really exist.
