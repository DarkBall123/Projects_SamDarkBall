...
|-
| **type**
| the type of the animation, e.g. rotating or translation. Refer to Model Config for a list of all animation types.
|-
| **source**
| The source used to animate the selection. Refer to Model Config for a list of all sources.
|-
| **selection**
...
, the source is returning 0 when the vehicle is not moving and 1 when the vehicle is moving at maximum speed.
- If using
