...
Since 2.10 skipTime is limited to max +/- 1000 hours per skip for game stability. The command is intended for short time jumps. For large intervals, use setDate.
...
setDate accTime setTimeMultiplier timeMultiplier BIS_fnc_setDate
}}
