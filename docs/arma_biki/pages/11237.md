...
**-par** [startup parameter](Arma 3: Startup Parameters) allows to specify the file.
Whether using #Plain Text Format or #.par Format, **the file is preprocessed before parsing**, allowing C++ style comments and `#define`s to be used.
{{Feature|informative|Before {{arma2oa}} v1.60.86060, only the `[.par](#.par Format)` format was supported.}}
...
- [Feature is discussed here by Suma](https://web.archive.org/web/20151114132158/http://dev.withsix.com/issues/26103)
