...
The current camera position is represented by 32px and an approximate view cone.
...
- 32px Normal object, can be edited
- 32px Destroyed object, can be edited
- 32px Not in the editing area, cannot be edited
- 32px Player, cannot be edited
- 32px Waypoint, can always be edited

#### Editing

Click and drag an entity using {{Controls|LMB}} to edit it.
- 32px Move it around by default. When vehicle crew is selected, it will be moved out of their vehicle.
- 32px Hold {{Controls|Left Alt}} to change the height.
- 32px When a vehicle is under the cursor, selected soldiers are moved inside.
- 32px Hold {{Controls|Left Shift}} to rotate it.
- 32px When the entity is outside of the editing area or is being dragged into it, editing is not possible.
...
- 32px MOVE having clicked on an empty space
- 32px GET IN having clicked on a vehicle
- 32px DESTROY having clicked on an enemy
- 32px CYCLE when {{Controls|Left Alt}} is held - upon reaching it, the unit will repeat the waypoints from the first one.
...
- 32px32px Grouping - when Units or Groups modes are selected, you can group them together. Works only with AI units (e.g. soldiers or manned vehicles)
- 32px Syncing - when Modules mode is selected, objects are synchronized. Some modules may require synchronization to affected objects.
...
- Select editing mode
- 32px Objects (soldier, vehicles and objects, can be placed only in the editing area)
- 32px Groups of objects
- 32px Modules (systems like artillery strikes, respawn points, weather settings, ...). Can usually be placed anywhere.
- 32px Markers (visible to every player, can be placed anywhere for free)
- Pick a side.
