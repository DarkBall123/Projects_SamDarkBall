...
- Source: https://community.bistudio.com/wiki/BIS_fnc_planeEjection
- Revision: 376186
- Updated: 2025-09-13T15:54:41Z
...
```sqf
[plane, delay] spawn BIS_fnc_planeEjection
```

### Parameters

- plane: Object - living vehicle with a pilot and with ejection systems set up in its config
- delay: Number - (Optional, default -1) delay in seconds between function execution and when the ejection actually happens. 0 or lower means no delay.
...
BIS_fnc_planeAiEject BIS_fnc_planeEjectionFX BIS_fnc_ejectionSeatRelease
