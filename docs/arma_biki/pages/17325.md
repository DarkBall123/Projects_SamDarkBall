...
- Source: https://community.bistudio.com/wiki/Arma_3:_Task_Framework
- Revision: 373678
- Updated: 2025-06-10T15:49:57Z

{{TOC|side}}

### Framework Structure (1.00)
...
|-
| BIS_fnc_setTaskLocal || Function that locally creates or updates task data. This function is designed to be executed only from inside of the framework, do not execute it directly.
|}
```
...
1. task type icon - texture of task type icon defining nature of the task; replaces the former task label
1. distance indicator - standardized info about task distance
...
1. parent/child task folding visualization and functionality was fixed
...
1. The 'Diary' action was remapped to 2x[J] as its former keybind was taken by the 'Task Overview' action.
...
! Task Type
|-
| style="width: 32px; background-color: #000" | File:bis_tasktype_airdrop.png
| style="width: 130px" | airdrop
|-
...
|-
| style="width: 32px; background-color: #000" | File:bis_tasktype_unknown.png
...
|-
| style="width: 32px; background-color: #000" | File:bis_tasktype_truck.png
| style="width: 130px" | truck
|-
