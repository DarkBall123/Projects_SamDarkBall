...
- Source: https://community.bistudio.com/wiki/Mod.cpp%2Fbin_File_Format
- Revision: 373415
...
As of 2.02 CfgMods is broken and does not work!
The alternative is to insert a CfgMods class into one of your pbo's, or, make one specifically for this.
The following are BI samples of how it is done (find more samples here):
...
Use **
  - to get a line break for mod overview.
