...
thumb|Layout button
thumb|RscDisplayChooseEditorLayout
thumb|MessageBox that appears after clicking OK button in RscDisplayChooseEditorLayout.
### Description
...
- Parameters of the layout's class:
  - **name** - name of the class that will be used as resource for the layout. If name of non-existing class is used, *RscDisplayArcadeMap* is used as a failsafe.**name** can be anything but should be unique within CfgEditorLayouts.
