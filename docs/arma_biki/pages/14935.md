...
Animals placed by the mission designer are global and every player in a multiplayer mission can see them.
...
thumb|200px|right|Working of the Ambient System in Arma 3.
...
1. Main spawn circle is processed.
  ...
  1. Conditions in the center of each testing circle are checked and evaluated, the number of missing animals for the testing circle area is counted ([how many animals should be here according to conditions] - [how many animals are already here]).
  1. One animal type for each main spawn circle is created according to the counted probability.
