...
- Source: https://community.bistudio.com/wiki/Config.cpp%2Fbin_File_Format
- Revision: 373403
...
- A cpp can, as equally, contain binarised content. No harm is done, and, indeed, this is familiar territory to [rvmat files](Rvmat File Format) where there is no distinction. An rvmat (e.g) contains either format.
