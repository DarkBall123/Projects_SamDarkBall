...
- Revision: 378893
- Updated: 2026-08-11T14:19:04Z

{{TOC|side}}
Most Arma 3 DLCs & Expansions come with restrictions regarding the usage of their premium assets (e.g. vehicles and weapons).
This technology is referred to as Content Licensing.
Some DLC assets are *not* covered by this limitation and are added to the base game / platform for free (e.g. decorative props).

{{Feature|informative|
- All (premium) DLC assets can be tested without any kind of limitation or ads in the Arsenal.
- As the in-game ads will tell, press {{Controls|LShift|P}} in order to open the DLC Content Browser menu.
- See the [Roadmap 2014/15 - Arma 3 DLC Strategy](https://www.bohemia.net/blog/roadmap-14-15-dlc-strategy-blog) blog post for further information.
}}

{{Feature|informative|
{{Icon|arma3spex|25}} For the restrictions of the Spearhead 1944 CDLC and its companion modification SPEX - Spearhead Extended visit Spearhead Extended Asset Restrictions.
}}
...
The terrain simply cannot be accessed (even in Eden Editor).

#### Mission Restrictions

If the mission is DLC-restricted, the mission cannot be started (such as some official Showcases and Challenges).
- In Eden Editor, restrictions are set via **Attributes > General > Overview > DLC** and **Require DLC** if necessary.
...
- These tables are valid as of Arma 3 **v2.22**.
- **Personal Equipment** list icons are based on Arsenal.
- **Vehicles** list icons are based on Eden Editor's Asset Browser.
...
| UH-80 Ghost Hawk (Unarmed)
|
| No
|-
| CTRG
| B_CTRG_Heli_Transport_01_DAP_F
| MH-80 DAP Ghost Hawk
|
| No
|-
| CTRG
