## Arma 3: Field Manual - General

- Source: https://community.bistudio.com/wiki/Arma_3:_Field_Manual_-_General
- Revision: 349726
- Updated: 2023-11-20T22:09:54Z

### General
#### Action Menu
The action menu is a context sensitive list of available actions. It changes depending on the object pointed at with the cursor. **Icons** 24px 24px 24px near the weapon cursor indicate a new default action.
...
#### Inventory
- Access your Inventory 24px by pressing **[I]**.
...
- Point the cursor at the item until the 24px icon appears.
...
- Select **Rearm 24px**. This will replenish your magazines up to your default loadout count.
