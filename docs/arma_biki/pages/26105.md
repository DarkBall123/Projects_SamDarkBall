## Arma 3: Alien Entity Behavior

- Source: https://community.bistudio.com/wiki/Arma_3:_Alien_Entity_Behavior
- Revision: 370230
- Updated: 2024-11-12T23:10:53Z

{{TOC|side}}

"First Contact" campaign of Arma 3 Contact
1.94
...
1. Gravity Tool Module: used to process and launch collected matter in two lethal modes:
  1. Matter Shot: a precise single shot of matter
  1. Matter Burst: a multi-round burst of matter
1. Matter: used to store collected matter as a resource
  1. If it runs out, the entity will collect more from any surface
  1. If it gets dislodged from its orbit, it will fall to the ground and decay (there is some danger to those who get close)
...
1. Audiovisual Deception: this uses light and sound to disorient threats
1. Gravity Matter Swarm: this launches a cluster of semi-guided area denial projectiles
1. Gravity Matter Push: this launches matter in all directions as a less-than-lethal defense against nearby threats
...
1: **Target**: Object or Position - where the module should aim at
...
- Alien Entity: Combat Behavior example mission - https://steamcommunity.com/sharedfiles/filedetails/1819779586
- Alien Entity: Safe Behavior example mission - https://steamcommunity.com/sharedfiles/filedetails/1819778427
