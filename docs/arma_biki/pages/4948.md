...
A [Finite-State Machine](https://en.wikipedia.org/wiki/Finite-state) (as defined on Wikipedia) "is a model of behavior composed of states, transitions and actions".
...
Each state has `init` and `precondition` section, while each conditional link has `precondition`, `condition` and `action` sections.
...
- FSM Editor
- [https://www.ofpec.com/editors-depot/index.php?action{{=}}details&id{{=}}459&game{{=}}ArmA Rune's FSM Tutorial] for ArmA, mirrored by [OFPEC](https://www.ofpec.com/)
- [Libero](http://imatix-legacy.github.io/libero/index.htm) - a free, commercial grade FSM IDE by https://en.wikipedia.org/wiki/Pieter Hintjens at [iMatix](https://imatix-legacy.github.io/)
- https://en.wikipedia.org/wiki/Finite-state machine
- [National Institute for Standards and Technology's Definition of Finite State Machine](http://www.nist.gov/dads/HTML/finiteStateMachine.html)
