...
This documentation is mostly useful to [Creator DLC](https://arma3.com/dlc/creator) developers, although some selected parts can be applied to community mods as well.
...
General information on configuring records in the Field Manual can be found here.
...
<t color='#999999'>This content is exclusive to My First DLC.
Press <t /><t color='#19d3ff'>Left Shift + P<t /><t color='#999999'> to open the store page for more information.<t />"";
...
1. String: Arsenal asset class or Array [String: Arsenal asset class, Array [Strings: Arsenal items]]
...
- *overviewPicture* (DLC):
  ...
  - Recommended effects (vanilla): none
thumb|none|*overviewPicture* (DLC)
...
- *overviewPicture* (asset):
  ...
  - Recommended effects (vanilla): none
thumb|none|*overviewPicture* (asset)
- *picture* (spotlight):
