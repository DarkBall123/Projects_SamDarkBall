...
Absolute paths are not supported, such as those generated using getMissionPath. Attempting to check an absolute path will result in this error in RPT logs:
...
|text= Returns true for empty strings: 
