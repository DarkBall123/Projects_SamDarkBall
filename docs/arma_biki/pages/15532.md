...
|COMPATIBILITY= Arma 3 Official Tools
...
|DESCRIPTION= This special executable aims to help community creators in tweaking their addons. It contains various diagnostic tools that display the current game state in various conditions. See also: Performance Profiling. Extra commands available can be found here: Arma 3: Scripting Commands: Diagnostic Branch.
