...
- Added: "OnAutoSelectRole" / "OnPlayerSelectRole" [server-side](Arma_3:_Server_Side_Scripting) Event Handlers - https://feedback.bistudio.com/T198797
...
- Fixed: Many [lnb*](Category:Command_Group:_GUI_Control_-_ListNBox) script commands were missing error messages for invalid arguments - https://feedback.bistudio.com/T198100
...
- Added: Script conditions to [3DEN Attributes](Eden_Editor:_Configuring_Attributes)
...
- Added: Mimalloc memory allocator
