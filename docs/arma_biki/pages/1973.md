...
{{{!}} class="wikitable float-right align-center"
! Team
! Value
{{!}}-
{{!}} White
...
In a unit's init script in the editor spawn should be used, otherwise a [race condition](https://en.wikipedia.org/wiki/Race_condition) may be experienced:
