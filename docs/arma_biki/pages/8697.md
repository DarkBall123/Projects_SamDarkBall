...
### Endian
[Little endian](https://en.wikipedia.org/wiki/Endianness#Little-endian) byte order, lsb first for numeric values,
text is stored in [Big endian](https://en.wikipedia.org/wiki/Endianness#Big-endian) byte order.
### Data Types
```mediawiki-table
{| border="0"
