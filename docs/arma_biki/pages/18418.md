...
| 300
|
* minimal cutoff frequency (see: [Cutoff Frequency](https://en.wikipedia.org/wiki/Cutoff_frequency) on Wikipedia))
...
| 1
|
* slope of attenuation curve in frequency spectrum (see [Q factor](https://en.wikipedia.org/wiki/Q_factor) on Wikipedia
