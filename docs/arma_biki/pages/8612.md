...
- position: Position (Z-value is ignored) - centre of a hardcoded 200m radius
- timeMax: Number - max age of the target
- candidates: Array of Arrays with [accuracy, target, targetSide, targetType, targetPosition, targetAge]
...
* targetPosition: Position2D - [x,y] of the target 
* targetAge: Number - the actual target age in seconds (can be negative)
See targetsQuery format.

### Return Value

- Array with [countInfo, sideInfo, unitInfo, placeInfo, timeInfo, uCountInfo, uTypeInfo]
