...
Returns the name of the topmost commanding menu or "" if the menu is closed. For action menu visibility check see isActionMenuVisible. See #Notes for {{arma2}}/Arma 3 structure.
...
|text= Arma 3 possible values (thanks to **RCA3**):
* **""** - means the menu is closed
