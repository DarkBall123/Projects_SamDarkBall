...
500px|right|Splendid Camera Interface|
...
It is also possible to shot a screen via Steam (default {{Controls|F12}}). See [Steamworks Documentation](https://partner.steamgames.com/doc/features/screenshots) for more information.
...
[THIS IS WAR PHOTOGRAPHY by Karel Moricky](https://arma3.com/news/this-is-war-photography)
