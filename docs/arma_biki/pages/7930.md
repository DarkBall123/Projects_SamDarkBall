...
- Source: https://community.bistudio.com/wiki/Rvmat_File_Format
- Revision: 373457
- Updated: 2025-05-08T13:33:37Z

Rvmat files are the texture (material) files introduced with {{arma1}}. Their syntax is similar to that of a [config file](Config.cpp/bin File Format).

### Base Format

The minimum construct of an rvmat file is as below; however, it is recommended to use [TexGen](#TexGen Usage) as described below to save on `uvTransform` declarations.
