...
The [Visual Upgrade](https://dev.arma3.com/post/oprep-visual-upgrade) is a collection of small and big changes in the project files (configs, textures and materials), the most visible being the ToneMapping and lighting configuration.
