...
- The briefing can be interrupted by setting a variable:
...
.
- To hide the standard briefing screen that normally opens after the Intro phase ends, add the line

```
briefing = 0;
```

 in the Description.ext file in your mission folder.
