    ...
    class Sting_Dialog
    {
        ...
        class controls
        {
            ...
            class TopLeftIcon : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_signal.paa";
                onLoad = "uiNameSpace setVariable [""Sting_SignalPicture"", _this # 0];";
            ...
            class TopLeftValue : ctrlStructuredText
            {
                ...
                size = GRID_H(1.2);
                text = "75";
                onLoad = "uiNameSpace setVariable [""Sting_SignalText"", _this # 0];";
            ...
            class TopRightIcon : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_controller.paa";
            ...
            class CompassBar : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_compass.paa";
            ...
            {
                idc = -1;
                onLoad = "uiNameSpace setVariable [""Sting_CompassGroup"", _this # 0];";
                ...
                class controls
                {
                    class CompassLetterN : ctrlStructuredText
                    {
                        ...
                        size = GRID_H(1.4);
                        text = "N";
                        onLoad = "uiNameSpace setVariable [""Sting_CompassN"", _this # 0];";
                    ...
                    class CompassLetterE : ctrlStructuredText
                    {
                        ...
                        size = GRID_H(1.4);
                        text = "E";
                        onLoad = "uiNameSpace setVariable [""Sting_CompassE"", _this # 0];";
                    ...
                    class CompassLetterS : ctrlStructuredText
                    {
                        ...
                        size = GRID_H(1.4);
                        text = "S";
                        onLoad = "uiNameSpace setVariable [""Sting_CompassS"", _this # 0];";
                    ...
                    class CompassLetterW : ctrlStructuredText
                    {
                        ...
                        size = GRID_H(1.4);
                        text = "W";
                        onLoad = "uiNameSpace setVariable [""Sting_CompassW"", _this # 0];";
            ...
            class HeadingText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.6);
                text = "032";
                onLoad = "uiNameSpace setVariable [""Sting_HeadingText"", _this # 0];";
            ...
            class HeadingPointerDown : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_pointer_down.paa";
            ...
            class Center_target : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_center.paa";
            ...
            class VBarLeft : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_vbar_left.paa";
                onLoad = "uiNameSpace setVariable [""Sting_VBarLeft"", _this # 0];";
            ...
            class VBarRight : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_vbar_right.paa";
                onLoad = "uiNameSpace setVariable [""Sting_VBarRight"", _this # 0];";
            ...
            class VPointerLeft : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_pointer_left.paa";
                onLoad = "uiNameSpace setVariable [""Sting_VPointerLeft"", _this # 0];";
            ...
            class VPointerRight : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_pointer_right.paa";
                onLoad = "uiNameSpace setVariable [""Sting_VPointerRight"", _this # 0];";
            ...
            class AltLeftText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.3);
                text = "061";
                onLoad = "uiNameSpace setVariable [""Sting_AltText"", _this # 0];";
            ...
            class DistRightText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.3);
                text = "10483";
                onLoad = "uiNameSpace setVariable [""Sting_RightText"", _this # 0];";
            ...
            class BottomDistanceText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.3);
                text = "11861ft";
                onLoad = "uiNameSpace setVariable [""Sting_DefaultText"", _this # 0];";
            ...
            class LeftStatusIcon : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_p_icon.paa";
            ...
            class LeftVoltText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.2);
                text = "15.0V";
                onLoad = "uiNameSpace setVariable [""Sting_LeftVoltText"", _this # 0];";
            ...
            class LeftCurrentText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.2);
                text = "11.4A";
                onLoad = "uiNameSpace setVariable [""Sting_LeftCurrentText"", _this # 0];";
            ...
            class LeftMahText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.2);
                text = "2406mAh";
                onLoad = "uiNameSpace setVariable [""Sting_LeftMahText"", _this # 0];";
            ...
            class RightStatusIcon : ctrlStaticPicture
            {
                ...
                shadow = 2;
                shadowColor[] = {0, 0, 0, 1};
                text = "\sting\pictures\osd_batt_icon.paa";
            ...
            class RightVoltText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.2);
                text = "12.3V";
                onLoad = "uiNameSpace setVariable [""Sting_RightVoltText"", _this # 0];";
            ...
            class RightTimeText : ctrlStructuredText
            {
                ...
                size = GRID_H(1.2);
                text = "11:45";
                onLoad = "uiNameSpace setVariable [""Sting_TimeText"", _this # 0];";
