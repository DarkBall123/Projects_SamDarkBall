...
`demo_01` теперь использует расширенный формат карты с отдельным `floorGrid`, так что пол рендерится как полноценная поверхность, а лавовые ячейки наносят урон.
