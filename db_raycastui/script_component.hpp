...
#define DB_RUI_CAMERA_EYE_HEIGHT 0.50
#define DB_RUI_CEILING_HEIGHT 1.00
#define DB_RUI_FLOOR_HEIGHT_DEFAULT 0.00
#define DB_RUI_PIT_FLOOR_HEIGHT -1.05
#define DB_RUI_LAVA_DAMAGE_PER_SEC 18
#define DB_RUI_SLIME_DAMAGE_PER_SEC 38
#define DB_RUI_LAVA_PIT_DEPTH 0.30
...
#define DB_RUI_S_FLOOR_HEIGHT_GRID 28
#define DB_RUI_S_STEP_CTRLS 29
#define DB_RUI_S_CAMERA_FLOOR 30
...
#define DB_RUI_IS_PIT_FLOOR(TYPE) (((TYPE) isEqualTo DB_RUI_FLOOR_LAVA) || {(TYPE) isEqualTo DB_RUI_FLOOR_SLIME})
#define DB_RUI_GET_FLOOR_HEIGHT(TYPE) (if (DB_RUI_IS_PIT_FLOOR(TYPE)) then {DB_RUI_PIT_FLOOR_HEIGHT} else {DB_RUI_FLOOR_HEIGHT_DEFAULT})
